...
class Abbigliamento {
    ...
    constructor(id:number,codprod:number,collezione:string,capo:string,modello:number,quantità:number,colore:string,prezzoivaesclusa:number,disponibile:string,saldo:number){
        this.id = id;
